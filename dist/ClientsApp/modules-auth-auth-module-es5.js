...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-auth-auth-module"], {
  ...
  /*! exports provided: default */
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppModulesAuthPagesRegisterRegisterComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDataModelsValidatorTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppModulesAuthAuthRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */
    var _pages_login_login_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__( /*! ./pages/login/login.component */"./src/app/modules/auth/pages/login/login.component.ts");
    /* harmony import */
    var _pages_register_register_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__( /*! ./pages/register/register.component */"./src/app/modules/auth/pages/register/register.component.ts");
    var routes = [{
      path: "",
  ...
  function srcAppModulesAuthAuthModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */
    var _auth_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__( /*! ./auth-routing.module */"./src/app/modules/auth/auth-routing.module.ts");
    /* harmony import */
    var _pages_register_register_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__( /*! ./pages/register/register.component */"./src/app/modules/auth/pages/register/register.component.ts");
    /* harmony import */
    var _modals_modal_login_error_modal_login_error_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__( /*! ./modals/modal-login-error/modal-login-error.component */"./src/app/modules/auth/modals/modal-login-error/modal-login-error.component.ts");
  ...
  function srcAppModulesAuthPagesLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */
    var src_app_data_services_user_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__( /*! src/app/data/services/user.service */"./src/app/data/services/user.service.ts");
    /* harmony import */
    var _modules_auth_modals_modal_login_error_modal_login_error_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__( /*! @modules/auth/modals/modal-login-error/modal-login-error.component */"./src/app/modules/auth/modals/modal-login-error/modal-login-error.component.ts");
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(userService, router, formBuilder, modalService) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function getlogin() {
          ...
          if (this.log.valid) {
            ...
            this.bsModalRef = this.modalService.show(_modules_auth_modals_modal_login_error_modal_login_error_component__WEBPACK_IMPORTED_MODULE_6__["ModalLoginErrorComponent"], {
  ...
  /*! exports provided: default */
  /***/
  function srcAppModulesAuthPagesRegisterRegisterComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppModulesAuthPagesRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */
    var _modules_auth_modals_modal_login_error_modal_login_error_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__( /*! @modules/auth/modals/modal-login-error/modal-login-error.component */"./src/app/modules/auth/modals/modal-login-error/modal-login-error.component.ts");
    /* harmony import */
    ...
    /* harmony import */
    var src_app_data_models_validator__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__( /*! src/app/data/models/validator */"./src/app/data/models/validator.ts");
    /* harmony import */
    var src_app_data_services_user_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__( /*! src/app/data/services/user.service */"./src/app/data/services/user.service.ts");
    var RegisterComponent = /*#__PURE__*/function () {
      function RegisterComponent(userService, router, formBuilder, modalService) {
      ...
      _createClass(RegisterComponent, [{
        ...
        key: "password2",
        get: function get() {
          return this.log.get('password2');
        }
        /* Called on each input in either password field */
      }, {
        key: "onPasswordInput",
        value: function onPasswordInput() {
          if (this.log.hasError('passwordMismatch')) this.password2.setErrors([{
            'passwordMismatch': true
        ...
        value: function getRegister() {
          ...
          var firstform = this.log.value;
          if (this.log.valid) {
            this.userService.register(firstform.email, firstform.pwd).subscribe(function (response) {
              var body = response.body;
              var status = response.status;
            ...
            this.bsModalRef = this.modalService.show(_modules_auth_modals_modal_login_error_modal_login_error_component__WEBPACK_IMPORTED_MODULE_4__["ModalLoginErrorComponent"], {
              "class": 'modal-dialog-centered',
              backdrop: 'static',
              keyboard: false,
              initialState: initialState
